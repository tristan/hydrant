...
var SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_media_prefix) {
        ...
        quickElement('img', filter_p, '', 'src', admin_media_prefix + 'img/kepler/selector-search.gif');
        ...
        quickElement('img', selector_filter, '', 'src', admin_media_prefix + (is_stacked ? 'img/kepler/selector_stacked-add.gif':'img/kepler/selector-add.gif'), 'alt', 'Add');
